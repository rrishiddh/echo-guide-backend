...
const listingSchema = new Schema<IListing>(
  {
    ...
    title: {
      ...
      trim: true,
      minlength: [1, "Title must be at least 10 characters"],
    ...
    description: {
      ...
      trim: true,
      minlength: [1, "Description must be at least 50 characters"],
    ...
    itinerary: {
      ...
      trim: true,
      minlength: [1, "Itinerary must be at least 20 characters"],
